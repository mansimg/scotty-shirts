    ...
    <div className="Control">
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <input
          ...
          onMouseUp={(e) => changeFinal(e.target.value)}
        />
        &nbsp;&nbsp;&nbsp;
...
const UndoRedo = ({ undo, redo, currCommand, shapesLen }) => {
  // console.log(currCommand);
  return (
    <div className="Control">
      <h3>Undo / Redo:</h3>
      <div className="UndoRedoButtonsContainer">
        <button disabled={currCommand <= -1} onClick={() => undo()}>
          <ImUndo className="ButtonIcon" />
          Undo
        </button>{" "}
        <button disabled={currCommand + 1 >= shapesLen} onClick={() => redo()}>
  ...
  return (
    <div className="ControlPanel">
      ...
      <BorderWidth
        ...
        changeCurrBorderWidth={changeCurrBorderWidthMove}
        changeFinal={changeCurrBorderWidthUndo}
      />
      <FillColor
        currFillColor={currFillColor}
