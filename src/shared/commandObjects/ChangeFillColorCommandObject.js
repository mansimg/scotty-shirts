...
export default class ChangeFillColorCommandObject extends CommandObject {
  ...
  canExecute() {
    ...
    return this.targetObject !== undefined && this.targetObject.type !== "line";
  }
   ...
   */
  execute() {
    this.objExecute(this.objId, this.oldValue, this.newValue);
   ...
   */
  undo() {
    this.objUndo(this.objId, this.oldValue, this.newValue);
    // this.objId.fillColor = this.oldValue;
   ...
   */
  redo() {
    this.objRedo(this.objId, this.oldValue, this.newValue);
    // maybe also need to fix the palette to show this object's color?
  }
